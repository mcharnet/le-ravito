  ...
  const values = [
    {
      ...
      title: "Local & Bio",
      description:
        "Nous privilégions les producteurs locaux et les produits biologiques pour vous offrir le meilleur de la région lyonnaise.",
    ...
    },
    {
      ...
      title: "Communauté",
      description:
        "Le Ravito est plus qu'un café, c'est un lieu de rencontre pour tous les passionnés de sport et de bien-être.",
    ...
    },
    {
      ...
      title: "Qualité",
      description:
        "Chaque produit est sélectionné avec soin pour répondre aux besoins nutritionnels des sportifs les plus exigeants.",
    ...
    },
    {
      ...
      title: "Passion",
      description:
        "Notre équipe partage votre passion pour le sport et vous accompagne avec des conseils personnalisés.",
  ...
  const team = [
    {
      ...
      description:
        "Traileuse accomplie, Charlotte a créé Le Ravito pour partager sa passion du sport et de l'alimentation sportive.",
    ...
    },
    {
      ...
      description:
        "Spécialiste de la cuisine healthy, Anaïs compose nos menus en fonction des saisons et des besoins des sportifs.",
    ...
    },
    {
      ...
      role: "Coach sportif",
      description:
        "Triathlète confirmé, Thomas organise nos événements sportifs et accompagne nos clients dans leurs défis.",
          ...
          <div className="container-custom text-center">
            <div className="space-y-6 max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-custom-grey/70 leading-relaxed">
                L'aventure du Ravito commence par une passion commune : créer un
                lieu où sport, nutrition et convivialité se rencontrent au cœur
                de Lyon.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-custom-grey/80 leading-relaxed">
                  <p className="text-lg">
                    Tout a commencé par un constat simple : en tant que sportifs
                    réguliers, nous avions du mal à trouver un endroit qui
                    combine{" "}
                  ...
                  <p className="text-lg">
                    Le Ravito est né de cette envie de créer un lieu unique dans
                    le 6ème arrondissement de Lyon, où chaque coureur, cycliste,
                    triathlète ou amateur de fitness peut se ressourcer,
                    échanger et découvrir des produits adaptés à ses besoins.
                  </p>

                  <p className="text-lg">
                    Notre approche ? Privilégier le{" "}
                    <span className="text-accent-orange font-semibold">
                      local
                    </span>
                    , proposer du{" "}
                    <span className="text-accent-blue font-semibold">bio</span>,
                    et créer une véritable{" "}
                    <span className="text-dark-green font-semibold">
                      communauté
                    </span>{" "}
        ...
        <section className="section-padding">
          <div className="container-custom">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-custom-grey/70 max-w-2xl mx-auto">
                Des passionnés à votre service, partageant votre amour du sport
                et du bien-être
              </p>
            </div>
          ...
          <div className="container-custom">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-custom-grey/70 max-w-3xl mx-auto">
                Nous collaborons avec des producteurs et artisans de la région
                lyonnaise pour vous garantir des produits frais, de qualité et
